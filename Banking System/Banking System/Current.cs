...
namespace Banking_System
{
    internal class Current : Account
    {
        ...
        public Current(string name, string surname, string accountNumber, int surchargeDate) : base(name, surname, accountNumber, "Current", surchargeDate, 1000)
        {

        }

        public Current(string name, string surname, string accountNumber, int surchargeDate, int v) : this(name, surname, accountNumber, surchargeDate)
        {
        }
